...
console.log("AdyLight3 Connected to MQTT broker");
...
var ADY_LIGHT = {
  ...
  setPowerOn: function(on) {
    console.log("Turning the AdyLight3 light %s!", on ? "on" : "off");
    if (on) {
      client.publish('AdyLight', 'on3');
      ADY_LIGHT.powerOn = on;
    } else {
      client.publish('AdyLight','off3');
...
var lightUUID = uuid.generate('hap-nodejs:accessories:Accesory2_1');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake light.
var light = exports.accessory = new Accessory('AdyLight_3', lightUUID);
