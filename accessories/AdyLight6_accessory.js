...
console.log("AdyLight6 Connected to MQTT broker");
...
var ADY_LIGHT = {
  ...
  setPowerOn: function(on) {
    console.log("Turning the AdyLight6 light %s!", on ? "on" : "off");
    if (on) {
      client.publish('AdyLight', 'on6');
      ADY_LIGHT.powerOn = on;
    } else {
      client.publish('AdyLight','off6');
...
light.username = "2A:2B:3D:4D:2E:AF";
