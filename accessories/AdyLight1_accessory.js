...
console.log("AdyLight1 Connected to MQTT broker");
...
var ADY_LIGHT = {
  ...
  setPowerOn: function(on) {
    ...
    console.log("Turning the AdyLight1 light %s!", on ? "on" : "off");

    if (on) {

      client.publish('AdyLight', 'on1');
...
var lightUUID = uuid.generate('hap-nodejs:accessories:Accesory1_1');
...
var light = exports.accessory = new Accessory('AdyLight_1', lightUUID);
